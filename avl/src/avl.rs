...
fn bindgen_test_layout_Node() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<Node>())).height as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(Node),
...
fn bindgen_test_layout_AVL() {
    ...
    assert_eq!(
        unsafe { &(*(::std::ptr::null::<AVL>())).root as *const _ as usize },
        0usize,
        concat!("Offset of field: ", stringify!(AVL), "::", stringify!(root))
    );
    assert_eq!(
...
extern "C" {
    pub fn insert_val(tree: *mut AVL, val: ::std::os::raw::c_int) -> bool;
}
extern "C" {
    pub fn remove_val(tree: *mut AVL, val: ::std::os::raw::c_int) -> bool;
}
extern "C" {
    pub fn new_tree() -> *mut AVL;
}
extern "C" {
    pub fn inorder(tree: *mut AVL);
}
extern "C" {
    pub fn del_tree(tree: *mut AVL);
}
